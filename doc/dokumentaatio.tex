...
on testattu paitsi kehittäjän puolesta, myös keskivertoa uutta käyttäjää
simuloiva on jakanut mielipiteitä ja huomioita.
Testattavaa ja korjattavaa pitäisi lisätä ainakin seuraaviin:
\begin{description}
